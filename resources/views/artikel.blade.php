                                        ...
                                        <div class="articles-content">
                                            ...
                                            <div class="title-box text-center">
                                                <div class="content-wrapper">
                                                    <h3 class="title-box-name" style="color: black;">Article</h3>
                                            ...
                                            <div class="articles-list d-flex flex-wrap justify-content-center">
                                                ...
                                                <article class="articles-item">
                                                    <div class="item-img">
                                                        <img src="{{ asset('gambar_artikel/'.$item->gambar) }}">
                                                    </div>
                                                    <div class="item-body">
                                                        <div class="item-title" style="color: black;">{{ $item->judul }}</div>
                                                        <p class="text">{{ \Illuminate\Support\Str::limit($item->deskripsi, 50) }} ...</p>
                                                        <a href="{{ url('readartikel/'.$item->id) }}" class="item-link d-flex align-items-baseline">
                                                            <span class="item-link-text" style="color: black;">Read more</span>
