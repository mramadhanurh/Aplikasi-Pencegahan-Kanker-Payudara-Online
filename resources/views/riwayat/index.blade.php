  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Riwayat</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="riwayat form-control">
        </div>
        <div class="form-group mb-3">
...
<div class="modal fade" id="edit-data" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Riwayat</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group mb-3">
            <label for="">Riwayat</label>
            <input type="text" id="edit_riwayat" class="riwayat form-control">
        </div>
        <div class="form-group mb-3">
            <label for="">Skor</label>
...
<div class="modal fade" id="delete-data" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Delete Riwayat</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <input type="hidden" id="delete_riwayat_id">
...
<script>
    $(document).ready(function () {
        ...
        function fetchriwayat()
        {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('tbody').html("");
                    var no = 1;
                    $.each(response.riwayat, function (key, item) { 
                         $('tbody').append(
                            `<tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-warning btn-sm btn-flat  edit_riwayat" value="${item.id}"><i class="fas fa-pencil-alt"></i></button>
                                    <button class="btn btn-danger btn-sm btn-flat  delete_riwayat" value="${item.id}"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>`
                         );
                    });
        ...
        $(document).on('click', '.delete_riwayat', function (e) {
            e.preventDefault();
            var riwayat_id = $(this).val();
            // alert(usia_id);
            $('#delete_riwayat_id').val(riwayat_id);
        ...
        $(document).on('click', '.delete_data', function (e) {
            ...
            $(this).text("Deleting");
            var riwayat_id = $('#delete_riwayat_id').val();
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response.status == 404) {
                        ...
                        $('#edit_riwayat').val(response.riwayat.riwayat);
                        $('#edit_skor').val(response.riwayat.skor);
                        $('#edit_riwayat_id').val(riwayat_id);
                    }
                }
            });
        });
        ...
        $(document).on('click', '.update_data', function (e) {
            ...
            var riwayat_id = $('#edit_riwayat_id').val();
            var data = {
                'riwayat' : $('#edit_riwayat').val(),
                'skor' : $('#edit_skor').val(),
            }
